...
//                val set = AnimatorSet()
//                val `in` = ObjectAnimator.ofFloat(progress, "alpha", 0f, 1f)
//                `in`.duration = 2500
//                `in`.interpolator = AccelerateInterpolator()
//                val out = ObjectAnimator.ofFloat(progress, "alpha", 1f, 0f)
//                out.duration = 2500
...
//                set.playSequentially(`in`, out)
            ...
            val animator1 = ObjectAnimator.ofFloat(colors, transitionName, -200f)
//            animator1.repeatCount = 0
//            animator1.duration = 1000
//
            val animator2 = ObjectAnimator.ofFloat(colors, transitionName, 100f)
//            animator2.repeatCount = 0
//            animator2.duration = 1000
//
            val animator3 = ObjectAnimator.ofFloat(colors, transitionName, 0f)
